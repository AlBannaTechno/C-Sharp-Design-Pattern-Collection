...
{
    namespace D1CustomStringBuilder
    {
        /**
         * we used rider/resharper to generate delegated members
         * Also replace with regex
         * relace : return _builder.(.+)$
         * with : _builder.$1\nreturn this;
         *
         * The rest done manually
         */
        class CustomStringBuilder
        {
            ...
            public CustomStringBuilder Append(CustomStringBuilder? value, int startIndex, int count)
            {
        ...
        public class D1CustomStringBuilder
        {
